...
## Instalación de Vagrant en Mac OS

Para mayor información sobre la máquina virtual Vagrant  para MAC OS pueden consultar los siguientes links:
http://cdn.oreillystatic.com/oreilly/booksamplers/9781449335830_sampler.pdf
...
![Imagen 4: Instalación de VirtualBox.](images/Instalacion de VirtualBox.png)
...
![Imagen 2: Comando de instalación.](images/Comando de instalacion.png)



![Imagen 3: Correcta instalación de Virtualbox.](images/Correcta instalacion de Virtualbox.png)


## Instalación de VirtualBox en Mac OS
...
![ ](images/ cd vagrant marquina virtual.png)
